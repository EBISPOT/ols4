 ...
 *
 * <p>The hierarchical-children flag regression found while adding this coverage is fixed on the
 * current {@code dev} baseline; the dedicated regression test in
 * {@code V1AncestorsJsTreeBuilderHierarchicalChildrenFlagTest} covers that fix as well.
 */
class V1AncestorsJsTreeBuilderTest {
    ...
    /** The merged hierarchical-children fix must make this entity expandable. */
    @Test
