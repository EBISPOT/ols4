...
public enum DefinedFields {
    ...
    CURATED_FROM("curatedFrom", "", "Curated text-to-term mappings for this entity.", "array"),
    CURATED_FROM_SOURCES("curatedFromSources", "", "The sources that provided curated mappings for this entity.", "array"),
    CURATED_FROM_SUBJECT_CATEGORIES("curatedFromSubjectCategories", "",
            "Subject categories from curated text-to-term mappings.", "array"),
    ...
    LINKS_TO("linksTo", "", "A list of entities that this entity links to.", "array"),
